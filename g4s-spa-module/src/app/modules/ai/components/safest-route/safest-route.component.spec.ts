...
describe('SafestRouteComponent', () => {
  ...
  beforeEach(() => {
    ...
    spy = spyOn(aService, 'getSafestRoute').and.returnValue(of(safestRoute));
  ...
  it('safestRoute should be sr', () =>{
    expect(component.safestRoute.length).toBe(safestRoute.length);
  });
