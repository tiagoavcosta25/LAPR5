...
namespace DDDSample1.Domain.Players
{
    public class CreatingPlayerDto
    {
        ...
        public CreatingPlayerDto(string name, string email, string password, string avatar, string phoneNumber, int year, int month, int day, string emotionalStatus, string facebook, 
