...
namespace DDDSample1.Domain.Players
{
    public class UpdatePlayerDto
    {
        ...
        public UpdatePlayerDto(Guid Id, string name, string email, string password, string phoneNumber, int year, int month, int day, string emotionalStatus, string facebook, 
